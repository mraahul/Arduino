...
void disp_Keypad(void) {
  ...
  //   tft.fillCircle(165, 131, 3, RED); //  tft.drawFastHLine(90, 130, 300, 0xFE00);
...
boolean loginpin(uint32_t key_num_pin)
{
  ...
  if (_loginid == true) {
    ...
    if (_enterpin_flag == true)
    {
      ...
      tft.fillRoundRect(90, 100, 300, 120, 10, 0x7CDE); //Light
      tft.fillRoundRect(95, 105, 290, 110, 10, 0x0950); //Dark
      tft.setFont(&FreeSansBold12pt7b);
      disp_text(140, 150, 1, WHITE, "Login successfull");
...
void Func_Loginpage() {
  ...
  if (_login_flag == true) {
    ...
    tft.setFont(&FreeSans9pt7b);
    disp_text(260, 2, 1, WHITE, "Please Enter 6 Digit ID.");
  ...
  if (_enterid_flag == false && _enterid_wrong_flag == true) {
    ...
    tft.fillRect(266, 30, 130, 27, WHITE);
  }
  if (_enterid_flag == true && _enterid_wrong_flag == false) {
    tft.fillRect(240, 2, 260, 18, 0x0021);
    //nurse_name = String(numb);
    // draw_RoundButton(260, 65, 185, 40, 5, WHITE, 0xFE00);
    disp_text(260, 2, 1, WHITE, "Enter 4 Digit PIN.");
  ...
  if (_enterid_flag == true && _enterid_wrong_flag == true) {
    ...
    tft.fillRect(266, 80, 100, 22, WHITE);
...
int touchdetect(int page_chk) {
  ...
  if (p.z > 5 && p.z < 1000) {
    ...
    else if (X > 165 && X < 240 && Y > 70 && Y < 130 && _volkeypad == true ) {    // Vol key2
      key_pressed(2);
      delay(100);
      return _gttvolpage;
    }
    else if (X > 241 && X < 315 && Y > 70 && Y < 130 && _volkeypad == true ) {    // Vol key3
      key_pressed(3);
      delay(100); return _gttvolpage;
    }
    else if (X > 315 && X < 390 && Y > 70 && Y < 130 && _volkeypad == true ) {    // Vol key backspace
    ...
    else if (X > 165 && X < 240 && Y > 130 && Y < 190 && _volkeypad == true ) {    // Vol key5

      key_pressed(5);
      delay(100); return _gttvolpage;
    }
    else if (X > 240 && X < 315 && Y > 130 && Y < 190 && _volkeypad == true ) {    // Vol key6

      key_pressed(6);
      delay(100); return _gttvolpage;
    }
    else if (X > 315 && X < 390 && Y > 130 && Y < 190 && _volkeypad == true ) {    // Vol key Clear
    ...
    else if (X > 165 && X < 240 && Y > 190 && Y < 250 && _volkeypad == true ) {    // Vol key8

      key_pressed(8);
      delay(100); return _gttvolpage;
    }
    else if (X > 240 && X < 315 && Y > 190 && Y < 250 && _volkeypad == true ) {    // Vol key9

      key_pressed(9);
      delay(100); return _gttvolpage;
    }
    else if (X > 315 && X < 390 && Y > 190 && Y < 250 && _volkeypad == true ) {    // Vol key Cancel
    ...
    else if (X > 165 && X < 240 && Y > 250 && Y < 310 && _volkeypad == true ) {    // Vol key 0

      key_pressed(0);
      delay(100); return _gttvolpage;
    }
    else if (X > 240 && X < 315 && Y > 250 && Y < 310 && _volkeypad == true ) {    // Vol key none
      //key_pressed(1);
      return _gttvolpage;
    }
    else if (X > 315 && X < 390 && Y > 250 && Y < 310 && _volkeypad == true ) {    // Vol key OK
...
void setup() {
  ...
  {
    Serial.println(F("Initialized 1"));
  }
